	...
	#region ContextMenu
		...
		private void contextMenuStrip1_Opening( object sender, CancelEventArgs e )
		{
			...
			if ( _masterPane != null && menuStrip != null )
			{
				...
				if ( _isShowContextMenu )
				{
					...
					item.Name = "save_as";
					item.Tag = "save_as";
					item.Text = "save_as";// _resourceManager.GetString( "save_as" );
					...
					item.Tag = "page_setup";
					item.Text = "page_setup"; //_resourceManager.GetString( "page_setup" );
					...
					item.Name = "show_val";
					item.Tag = "show_val";
					item.Text = "show_val"; //_resourceManager.GetString( "show_val" );
					...
					if ( pane == null || pane.ZoomStack.IsEmpty )
						menuStr = "unzoom"; //_resourceManager.GetString( "unzoom" );
					else
					{
						switch ( pane.ZoomStack.Top.Type )
						{
							...
							case ZoomState.StateType.Pan:
                                menuStr = "unpan";// _resourceManager.GetString( "unpan" );
								break;
							case ZoomState.StateType.Scroll:
                                menuStr = "unscroll";// _resourceManager.GetString( "unscroll" );
								break;
						}
					}
					...
					item.Name = "undo_all";
					item.Tag = "undo_all";
                    menuStr = "undo_all";// _resourceManager.GetString( "undo_all" );
					item.Text = menuStr;
                    ...
                    menuStr = "set_default";// _resourceManager.GetString( "set_default" );
					item.Text = menuStr;
		...
		public void Copy( bool isShowMessage )
		{
			if ( _masterPane != null )
			{
				...
				if ( isShowMessage )
				{
                    string str = "copied_to_clip";// _resourceManager.GetString( "copied_to_clip" );
